...
def parse_args():
    ...
    starting_parser.add_argument("-c", "--refdata", required=True,
    ...
    starting_parser.add_argument("-t", "--threads", default=None,
                                 help="(Optional) Number of CPU cores to use. Also may utilize 'max', 'half', 'third' and 'two_thirds' of total available cores")
