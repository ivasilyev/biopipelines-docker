...
def rpush_sampledata(sampledata_line):
    ...
    j = {"coverage": coverageGenomeRefData, "sampledata": {"sample_name": sampledata_list[0], "sample_path": "\t".join(sampledata_list[1:])}, "mask": inputMask, "threads": cpuThreadsString, "output": outputDir}
    if filteringGenomeRefData:
        j["filter"] = filteringGenomeRefData
